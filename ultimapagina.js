...
if (localStorage.getItem("simounaoLS") == "sim") {
    escuta4.innerText = "Você escuta outros estilos musicais além de Heavy Metal? Sim";
    ...
    escuta4.innerText = "Você escuta outros estilos musicais além de Heavy Metal? Não";
